...
const (
	...
	UserService_GetUserBySDT_FullMethodName = "/user.UserService/GetUserBySDT"
...
type UserServiceClient interface {
	...
	GetUserBySDT(ctx context.Context, in *GetUserBySDTRequest, opts ...grpc.CallOption) (*GetUserBySDTResponse, error)
...
func (c *userServiceClient) GetUserBySDT(ctx context.Context, in *GetUserBySDTRequest, opts ...grpc.CallOption) (*GetUserBySDTResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserBySDTResponse)
	err := c.cc.Invoke(ctx, UserService_GetUserBySDT_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	GetUserBySDT(context.Context, *GetUserBySDTRequest) (*GetUserBySDTResponse, error)
...
func (UnimplementedUserServiceServer) GetUserBySDT(context.Context, *GetUserBySDTRequest) (*GetUserBySDTResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserBySDT not implemented")
}
...
func _UserService_GetUserBySDT_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserBySDTRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetUserBySDT(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_GetUserBySDT_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserBySDT(ctx, req.(*GetUserBySDTRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetUserBySDT",
			Handler:    _UserService_GetUserBySDT_Handler,
		},
		{
